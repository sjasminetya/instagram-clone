<template>
  <v-app style="background: #f8f9f9;">
    ...
    <div class="category">
        <div class="d-flex">
            <v-icon large class="active">home</v-icon>
            <h4 class="active">Feed</h4>
        </div>
        <div class="d-flex">
        ...
        <div class="d-flex">
            <v-icon large>near_me</v-icon>
            <h4>Direct</h4>
        </div>
        <div class="d-flex">
            <v-icon large>donut_small</v-icon>
            <h4>Stats</h4>
        </div>
        <div class="d-flex">
